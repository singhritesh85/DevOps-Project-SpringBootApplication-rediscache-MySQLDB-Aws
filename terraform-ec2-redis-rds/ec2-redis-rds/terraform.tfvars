...
kms_key_id_ec2 = "arn:aws:kms:us-east-2:02XXXXXXXXX6:key/dXXXXXX3-XXXX-XXXX-XXXX-XXXXXXXXXXX9"
name = "SpringBootApp"
env = ["dev", "stage", "prod"]
...
##################### RDS DB Instance Parameters ################################
  ...
  db_subnet_group_name = "mysql-subnetgroup"        ###  postgresql-subnetgroup 
...
#  vpc_security_group_ids = ["sg-038XXXXXXXXXXXXc291", "sg-a2XXXXXXca"]
...
#  backup_retention_period = 7   ### For Demo purpose I am not creating any db backup.
  kms_key_id_rds = "arn:aws:kms:us-east-2:02XXXXXXXXXXX6:key/XXXXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXXX7"
